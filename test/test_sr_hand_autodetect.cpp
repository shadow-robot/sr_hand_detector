...
{
  std::string expected_command_sufix = " eth_port:=eth0 hand_serial:=1130 side:=right hand_type:=hand_e_plus";
  ...
  ASSERT_EQ(sr_hand_autodetect.get_command_suffix(), expected_command_sufix);
}

TEST(SrHandAutodetect, test_run_unimanual_additional_params)
{
  std::string expected_command_sufix = " eth_port:=eth0 hand_serial:=634 side:=right hand_type:=hand_e";
...
{
  std::string expected_command_sufix = " eth_port:=eth0_eth1 rh_serial:=634 lh_serial:=2346 hand_type:=hand_e";
  ...
  expected_command_sufix += " rh_mapping_path:=" + expected_rh_mapping_path;
  expected_command_sufix += " lh_mapping_path:=" + expected_lh_mapping_path;
